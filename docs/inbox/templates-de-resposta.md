---
title: Templates de Resposta — respostas prontas
description: Como criar templates de resposta rápida no Imobiturbo.OS, com variáveis e atalhos, para responder no atendimento em um clique.
---
...
|---|---|
| A variável veio em branco | O contato está sem esse dado cadastrado (ex.: sem primeiro nome). Preencha o contato em [Contatos](/docs/contatos/visao-geral-contatos). |
...
- [Abrir e responder uma conversa](/docs/inbox/abrir-e-responder-conversa)
